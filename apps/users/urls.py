...
urlpatterns = [
    ...
    path("parent/profile/update/<uuid:id>/", ParentProfileUpdateView.as_view(), name="parent-profile-update"),
    path("student/profile/update/<uuid:id>/", StudentProfileUpdateView.as_view(), name="student-profile-update"),
    path("teacher/profile/update/", TeacherProfileUpdateView.as_view(), name="teacher-profile-update"),
